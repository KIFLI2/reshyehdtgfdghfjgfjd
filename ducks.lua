...
local window = library:AddWindow("Stas Script", {
...
statsTab:AddButton("Copy Stats to Clipboard", function()
    ...
    statsText = statsText .. "ðŸƒ Agility: " .. formatNumberWithCommas(player.Agility.Value) .. "\n"
    ...
    if hasStartedTracking then
        ...
        statsText = statsText .. "ðŸƒ Agility Gained: " .. formatNumberWithCommas(agilityGain) .. "\n"
        ...
        if elapsedTime > 0 then
            ...
            statsText = statsText .. "ðŸƒ Agility: " .. formatNumberWithCommas(math.floor(agilityGain / minutesElapsed)) .. "/min\n"
